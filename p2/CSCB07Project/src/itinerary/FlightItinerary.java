...
public class FlightItinerary implements Serializable {
  ...
  /**
   * Returns the Departure Date and Time of the Itinerary.
   * 
   * @return A String representing the departure date and time of the first flight in the
   *     FlightItinerary.
   */
  ...
  public String toString() {
    ...
    for (Flight flight : flights) {
      itineraryString += (flight.getFlightNumber() + "," + flight.getDepartureTimeString()
          + "," + flight.getArrivalTimeString() + "," + flight.getAirline() + ","
