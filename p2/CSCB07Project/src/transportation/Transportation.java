...
public abstract class Transportation implements Serializable {
  ...
  public Transportation(String departureTime, String arrivalTime, String origin,
    ...
    SimpleDateFormat inputFormat = new SimpleDateFormat(Constants.TIME_DATE_FORMAT);
  ...
  public String getArrivalTimeString() {
    SimpleDateFormat outputFormat = new SimpleDateFormat(Constants.TIME_DATE_FORMAT);
   ...
   * Returns the difference between the arrival time and departure time of the Transportation
   * object.
   * @return A String representing the total travel time of the Transportation object in the
   *     format HH:MM.
   */
  public String getTravelTimeString() {
    long travelDuration = (arrivalTime.getTime() - departureTime.getTime());
    long durationInHours = TimeUnit.MILLISECONDS.toHours(travelDuration);
    long durationInMinutes = (TimeUnit.MILLISECONDS.toMinutes(travelDuration)
