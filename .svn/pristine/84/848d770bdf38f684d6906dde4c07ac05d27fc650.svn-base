...
public class Client implements Serializable {
   ...
   *           Throws a ParseException if expiryDate is given in format other
   *           than YYYY-MM-DD.
   */
  public Client(String lastName, String firstName, String email, 
      String address, String creditCardNumber, String expiryDate) throws ParseException {
    this.lastName = lastName;
    this.firstName = firstName;
    this.email = email;
    this.address = address;
    this.creditCardNumber = creditCardNumber;
    SimpleDateFormat expiryDateFormat = new SimpleDateFormat(Constants.DAY_DATE_FORMAT);
  ...
  public String getExpiryDateString() {
    SimpleDateFormat outputFormat = new SimpleDateFormat(Constants.DAY_DATE_FORMAT);
