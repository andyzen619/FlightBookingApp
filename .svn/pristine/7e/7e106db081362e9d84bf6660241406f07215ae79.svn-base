...
public class Client extends User implements Serializable {
	...
	public Client(String userName, String lastName, String firstName,
		...
		SimpleDateFormat expiryDateFormat = new SimpleDateFormat(
				Constants.DAY_DATE_FORMAT);
	...
	/**
	 * @param bookedFlightItineraries
	 *            the bookedFlightItineraries to set
	 */
